...
//    ENCRYPT -------------------------------------------------------------------------------
    ...
    private void keyExpension(){
        int[][][] expandedKeys = new int[forLoop][4][4];
        int[] temp = new int[4];
...
//        sbox again
        temp1[0] = s_box[temp1[0]];
        temp1[1] = s_box[temp1[1]];
        temp1[2] = s_box[temp1[2]];
        temp1[3] = s_box[temp1[3]];

        temp1[0] ^= rcon[rcon_iteration];
    ...
    private void mixColumns(){
        ...
        for (int i = 0; i < 4; i++) {
            state[0][i] = mul2[temp[0][i]] ^ mul3[temp[1][i]] ^ temp[2][i] ^ temp[3][i];
            state[1][i] = temp[0][i] ^ mul2[temp[1][i]] ^ mul3[temp[2][i]] ^ temp[3][i];
            state[2][i] = temp[0][i] ^ temp[1][i] ^ mul2[temp[2][i]] ^ mul3[temp[3][i]];
            state[3][i] = mul3[temp[0][i]] ^ temp[1][i] ^ temp[2][i] ^ mul2[temp[3][i]];
        }
    }
